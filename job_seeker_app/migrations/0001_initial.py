    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='job_seeker_app.CustomUser')),
            ],
        ),
        migrations.CreateModel(
            name='PersonalInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(default=True, on_delete=django.db.models.deletion.CASCADE, to='job_seeker_app.Degree')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='job_seeker_app.CustomUser')),
            ],
        ),
    ]
